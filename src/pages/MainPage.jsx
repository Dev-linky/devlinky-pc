  ...
  return (
    <>
      <TabMenus selectTabMenu={selectTabMenu}>
        <li>
          <button type='button' onClick={handleClickTabMenu}>
            newlink
          </button>
        </li>
        <li>
      ...
      <Layout>
        {selectTabMenu === 'newlink' ? (
          <form>
            ...
            />
            <SaveButton type='button' id='btn-save' onClick={handleClickSave}>
              Save a contents
            </SaveButton>
          </form>
        ) : (
          <ArchiveTab mydevlinks={mydevlinks} />
        )}
      </Layout>
    </>
  );
...
const TabMenus = styled.ul`
  ...
  &
    li:nth-of-type(
      ${({ selectTabMenu }) => (selectTabMenu === 'newlink' ? 1 : 2)}
    ) {
  ...
  &
    li:nth-of-type(
      ${({ selectTabMenu }) => (selectTabMenu === 'newlink' ? 2 : 1)}
    ) {
    opacity: 0.5; /* 미 선택 */
  }
`;
